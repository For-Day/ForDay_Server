...
public enum ErrorCode {
    ...
    COVER_GENERATION_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "커버 이미지 생성이 지연되고 있어요. 잠시 후 다시 시도해주세요."),
    COVER_GENERATION_FAILED(HttpStatus.BAD_GATEWAY, "커버 이미지 생성 중 오류가 발생했습니다. 잠시 후 다시 시도해주세요."),
