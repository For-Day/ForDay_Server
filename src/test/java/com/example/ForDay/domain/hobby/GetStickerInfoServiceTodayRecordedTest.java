...
@Transactional
@ActiveProfiles("test")
class GetStickerInfoServiceTodayRecordedTest {
    ...
    void 스티커_1개_오늘기록함_전체페이지1_현재페이지null() {
        ...
        assertThat(result.isActivityRecordedToday()).isTrue();
    ...
    @Test
    void 스티커_28개_오늘기록함_전체페이지1_현재페이지null() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
    ...
    @Test
    void 스티커_30개_오늘기록함_전체페이지2_현재페이지2() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
    ...
    @Test
    void 스티커_56개_오늘기록함_전체페이지2_현재페이지null() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
    ...
    @Test
    void 스티커_56개_오늘기록함_전체페이지2_현재페이지1() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
    ...
    @Test
    void 스티커_66개_오늘기록함_전체페이지3_현재페이지null() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
    ...
    @Test
    void 스티커_66개_오늘기록함_전체페이지3_현재페이지1() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
    ...
    @Test
    void 스티커_66개_오늘기록함_전체페이지3_현재페이지2() {
        TestContext ctx = setupTestData(66, "독서", "성장", 30);
